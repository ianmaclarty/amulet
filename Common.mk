...
ifeq ($(TARGET_PLATFORM),osx)
  ...
  OBJ_OUT_OPT = -o$(SPACE)
  ifdef IS_WINDOWS
    CC = cmd //C /C/emscripten/emscripten/1.34.1/emcc.bat
    CPP = cmd //C /C/emscripten/emscripten/1.34.1/em++.bat
    AR = cmd //C /C/emscripten/emscripten/1.34.1/emar.bat
    LINK = cmd //C /C/emscripten/emscripten/1.34.1/em++.bat
  endif
