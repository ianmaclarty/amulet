...
local node1 = amulet.draw_arrays()
...
verts2[4] = math.vec2(-1, -1)
verts2[5] = math.vec2(1, 1)
verts2[6] = math.vec2(1, -1)
uvs2[1] = math.vec2(0, 0)
uvs2[2] = math.vec2(0, 1)
uvs2[3] = math.vec2(1, 1)
uvs2[4] = math.vec2(0, 0)
uvs2[5] = math.vec2(1, 1)
uvs2[6] = math.vec2(1, 0)
